		...
		<view class="flex flex-wrap justify-center" style="margin-top: 400rpx;">
			...
			<view style="margin-top:55rpx;">
				<view class="flex flex-nowrap">
					<input :password="showPassword" class="txt_password" placeholder="6-30位的数字字母组合" />
			...
			<view style="margin-top:55rpx;">
				<view class="flex flex-nowrap">
					<input :password="showConfirmPassword" class="txt_password" placeholder="6-30位的数字字母组合" />
	...
	export default {
		...
		methods: {
			...
			tabShowPassword : function(){
				...
				this.showPasswordIcon = this.showPassword ? '../../static/icon/biyan_icon.png' : '../../static/icon/zhengyan_icon.png'
			},
			tabConfirmShowPassword : function (){
				this.showConfirmPassword = !this.showConfirmPassword
				this.showConfirmPasswordIcon = this.showConfirmPassword ? '../../static/icon/biyan_icon.png' : '../../static/icon/zhengyan_icon.png'
			}
...
<style>
	...
	.btn_login {
		border-radius: 50rpx;background: linear-gradient(to right, #F8CC2F, #03A305 );
			font-size:33rpx;width:625rpx;height: 100rpx; line-height: 100rpx;
	}
	...
	.login_operation{
		font-size: 21rpx;color: #999999;
	}
	
	.txt_phone{
		width: 500rpx;margin-left: 35rpx;height: 80rpx;line-height: 80rpx;letter-spacing: 10rpx;font-size: 32rpx;
	}
	
	.txt_password{
		width: 580rpx;height: 80rpx;line-height: 80rpx;letter-spacing: 10rpx;
	}
