<template>
	<view style="position: fixed;bottom: 220rpx;left: 0;right: 0;">
		<scroll-view scroll-y="true" style="width: 669rpx;height: 498rpx;" scroll-with-animation class="<pl-3></pl-3>"
